...
HARNESS_SET_RUNTIME_DIR_OPERATOR_SET="${HARNESS_SET_RUNTIME_DIR+x}"
HARNESS_DOCKER_SET_RECORD_OPERATOR_SET="${HARNESS_DOCKER_SET_RECORD+x}"
HARNESS_BASELINE_DIR_OPERATOR_SET="${HARNESS_BASELINE_DIR+x}"
HARNESS_BASELINE_ARCHIVE_DIR_OPERATOR_SET="${HARNESS_BASELINE_ARCHIVE_DIR+x}"
HARNESS_BASELINE_MANIFEST_OPERATOR_SET="${HARNESS_BASELINE_MANIFEST+x}"
HARNESS_BASELINE_SSH_IDENTITIES_OPERATOR_SET="${HARNESS_BASELINE_SSH_IDENTITIES+x}"
...
HARNESS_SET_RUNTIME_DIR_OPERATOR_VALUE="${HARNESS_SET_RUNTIME_DIR-}"
HARNESS_DOCKER_SET_RECORD_OPERATOR_VALUE="${HARNESS_DOCKER_SET_RECORD-}"
HARNESS_BASELINE_DIR_OPERATOR_VALUE="${HARNESS_BASELINE_DIR-}"
HARNESS_BASELINE_ARCHIVE_DIR_OPERATOR_VALUE="${HARNESS_BASELINE_ARCHIVE_DIR-}"
HARNESS_BASELINE_MANIFEST_OPERATOR_VALUE="${HARNESS_BASELINE_MANIFEST-}"
HARNESS_BASELINE_SSH_IDENTITIES_OPERATOR_VALUE="${HARNESS_BASELINE_SSH_IDENTITIES-}"
...
HARNESS_SET_DIR="${HARNESS_SET_DIR:-$repo_root/generated/simulation/docker/sets/$HARNESS_SET_ID}"
HARNESS_SET_RUNTIME_DIR="${HARNESS_SET_RUNTIME_DIR:-$HARNESS_SET_DIR/runtime}"
HARNESS_DOCKER_SET_RECORD="${HARNESS_DOCKER_SET_RECORD:-$HARNESS_SET_DIR/docker-set.env}"
HARNESS_STATE_DIR="${HARNESS_STATE_DIR:-$HARNESS_SET_RUNTIME_DIR/helper-state}"
HARNESS_PRODUCT_HOME_DIR="${HARNESS_PRODUCT_HOME_DIR:-$HARNESS_SET_RUNTIME_DIR/product-homes}"
HARNESS_STAGING_DIR="${HARNESS_STAGING_DIR:-$HARNESS_SET_RUNTIME_DIR/artifacts/staging}"
...
HARNESS_LDAP_DATA_DIR="${HARNESS_LDAP_DATA_DIR:-$HARNESS_SET_RUNTIME_DIR/ldap/data}"
HARNESS_LDAP_CONFIG_DIR="${HARNESS_LDAP_CONFIG_DIR:-$HARNESS_SET_RUNTIME_DIR/ldap/config}"
HARNESS_SHARED_JENKINS_STORAGE_DIR="${HARNESS_SHARED_JENKINS_STORAGE_DIR:-$HARNESS_SET_RUNTIME_DIR/shared-jenkins-storage}"
...
load_env_file() {
  ...
  if [ -n "$HARNESS_GENERATED_RUN_DIR_OPERATOR_SET" ] ||
    ...
    [ -n "$HARNESS_SET_RUNTIME_DIR_OPERATOR_SET" ] ||
    [ -n "$HARNESS_DOCKER_SET_RECORD_OPERATOR_SET" ] ||
    [ -n "$HARNESS_BASELINE_DIR_OPERATOR_SET" ] ||
    [ -n "$HARNESS_BASELINE_ARCHIVE_DIR_OPERATOR_SET" ] ||
    [ -n "$HARNESS_BASELINE_MANIFEST_OPERATOR_SET" ] ||
    [ -n "$HARNESS_BASELINE_SSH_IDENTITIES_OPERATOR_SET" ] ||
  ...
  unset HARNESS_SET_DIR HARNESS_SET_RUNTIME_DIR HARNESS_DOCKER_SET_RECORD
  unset HARNESS_BASELINE_DIR HARNESS_BASELINE_ARCHIVE_DIR
  unset HARNESS_BASELINE_MANIFEST HARNESS_BASELINE_SSH_IDENTITIES
...
docker_config_load_runtime_if_present() {
  ...
  export HARNESS_SET_ID HARNESS_SET_DIR HARNESS_SET_RUNTIME_DIR
  export HARNESS_DOCKER_SET_RECORD HARNESS_SET_LOCK HARNESS_ACTIVE_RUN_FILE
...
HARNESS_SET_RUNTIME_DIR=$(shell_quote "$HARNESS_SET_RUNTIME_DIR")
HARNESS_DOCKER_SET_RECORD=$(shell_quote "$HARNESS_DOCKER_SET_RECORD")
