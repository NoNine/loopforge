...
a machine-generated checkpoint-result file. Do not store integration keys, scripts,
...
does not create a helper-style checkpoint-result file.
...
integration checkpoint-result file or copy routine service and command output. The
