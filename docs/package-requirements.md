...
| Integration native operations | `docs/integration-native-operations-reference.md` keeps the manual cross-role SSH, Gerrit access, Jenkins node, trigger, vote, and evidence procedures. |
