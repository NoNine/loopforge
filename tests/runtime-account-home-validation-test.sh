...
GERRIT_LOCAL_ARTIFACT_OUTPUT_DIR="/unused/local-artifacts"
GERRIT_PLUGIN_LIST="events-log,metrics-reporter-prometheus,healthcheck"
...
JENKINS_AGENT_STATE_DIR="/harness/state/agent"
...
JENKINS_AGENT_EXECUTORS="5"
JENKINS_AGENT_CREDENTIAL_ID="jenkins-agent-ssh"
JENKINS_AGENT_STATE_DIR="/harness/state/agent/install-validation"
